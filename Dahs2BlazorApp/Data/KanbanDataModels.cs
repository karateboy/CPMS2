...
namespace Dahs2BlazorApp.Data
{
    public class KanbanDataModels
    {
        ...
        public List<KanbanDataModels> GetCardTasks()
        {
            ...
            CardData.Add(new KanbanDataModels { Id = "Task 1", Title = "日報", Status = "Open", Summary = "上傳日報", Priority = "High", Tags = "Bug, Release Bug", RankId = 1, Assignee = "每日事項" });
            CardData.Add(new KanbanDataModels { Id = "Task 2", Title = "日報 - 輸入活動量", Status = "Close", Summary = "輸入活動量", Priority = "High", Tags = "Bug, Release Bug", RankId = 1, Assignee = "每日事項" });
            CardData.Add(new KanbanDataModels { Id = "Task 3", Title = "每日自動校正", Status = "InProgress", Summary = "每日校正", Priority = "High", Tags = "Bug, Release Bug", RankId = 1, Assignee = "每日事項" });
            CardData.Add(new KanbanDataModels { Id = "Task 4", Title = "月報", Status = "Open", Summary = "上傳月報", Priority = "Low", Tags = "Story, Kanban", RankId = 1, Assignee = "每月事項" });
            CardData.Add(new KanbanDataModels { Id = "Task 5", Title = "月報", Status = "Open", Summary = "上傳月報", Priority = "Low", Tags = "Story, Kanban", RankId = 1, Assignee = "每月事項" });
            CardData.Add(new KanbanDataModels { Id = "Task 6", Title = "校正", Status = "Open", Summary = "設定校正器材資訊", Priority = "Normal", Tags = "Story", Estimate = 0.5, RankId = 7, Assignee = "每月事項" });
            CardData.Add(new KanbanDataModels { Id = "輸入燃料資訊", Title = "輸入燃料資訊", Status = "Open", Summary = "輸入燃料資訊", Priority = "Normal", Tags = "Story", Estimate = 0.5, RankId = 7, Assignee = "每月事項" });
            return CardData;
        }
